...
public class DList {
	 ...
	 */
	public DList() {
		this.head = this.newNode(null, null, null);
	...
	public void insertAfter(Object item, DListNode node) {
		if (node != null) {
			DListNode insertNode = this.newNode(item, node, node.next);
	...
	public void insertBefore(Object item, DListNode node) {
		if (node != null) {
			DListNode insertNode = this.newNode(item, node.prev, node);
	...
	public void insertFront(Object item) {
		this.insertAfter(item, this.head);
	}
